// src/pages/services/branding/GraphicDesignAndVideoEditing.jsx
...
const SERVICE_CATEGORIES = [
  {
    ...
    label: "Logo Design",
    icon: PenTool,
    tagline: "A mark that holds up on a business card and a billboard.",
    description:
      "Custom logo design built from research and concept sketches, not templates — something that still looks right five years from now.",
    features: [
      "Custom concepts, not templates",
      "Multiple design directions to choose from",
      "Full logo suite: primary, icon & wordmark",
      "Source files & usage guidelines included",
    ],
  },
  {
    ...
    features: [
      "Platform-sized post & story templates",
      "Carousel & multi-slide designs",
      "Consistent visual system across posts",
  ...
  },
  {
    ...
    icon: FileText,
    tagline: "Print or digital, built to actually get read.",
    description:
      "Brochures, flyers and one-pagers laid out so the important information lands first — designed for print, digital, or both.",
    features: [
      "Print-ready & digital-ready layouts",
      "Clear information hierarchy",
      "Trifold, bifold & one-pager formats",
      "Brand-consistent typography & color",
    ],
  },
  {
    id: "banner-design",
...
const DELIVERABLES = [
  {
    ...
    description:
      "A custom logo built from concept sketches, delivered as a full suite with usage guidelines.",
    color: "#7FB4FF",
  },
  {
    icon: Image,
    ...
    description:
      "Posts, stories and carousels on a consistent visual system, sized right for every platform.",
    color: "#7F5FFF",
  },
  {
    icon: FileText,
    ...
    description:
      "Print and digital layouts that lead with the information that actually matters.",
    color: "#FF8B6B",
  },
  {
    icon: LayoutTemplate,
    ...
    description:
      "Multi-size banner sets built to spec, designed to earn the click instead of just filling space.",
    color: "#4E86FF",
  },
  {
    icon: Film,
    title: "Video Editing",
    description:
      "Reels, ads and promo videos cut and paced for the platform they're going out on.",
    color: "#22d3ee",
  },
  {
    icon: Clapperboard,
    ...
    description:
      "Animated logo stings, lower thirds and transitions that give video content a finished feel.",
    color: "#f472b6",
  },
];

const FORMATS_AND_PLATFORMS = [
  "Instagram",
  "Facebook",
  "YouTube",
  "LinkedIn",
...
const PROCESS = [
  {
    ...
    description:
      "Understand the brand, audience and what the piece needs to do before a single concept gets drawn.",
  },
  {
    index: "02",
    title: "Concept & Moodboard",
    description:
      "Early directions and reference boards, so the visual direction is agreed before full design begins.",
  },
  {
    index: "03",
    title: "Design & Edit",
    description:
      "Full design or edit produced against the approved direction, in every size and format needed.",
  },
  {
    index: "04",
    title: "Revisions",
    description:
      "Structured rounds of feedback and refinement until it's right, not just done.",
  },
  {
    index: "05",
    title: "Final Delivery",
    description:
      "Source files, exports and usage guidelines handed over, ready to publish or print.",
  },
];

export function GraphicDesignAndVideoEditing() {
  const [activeId, setActiveId] = useState("logo-design");
  ...
  // Logo Design. Resets on every activeId change, so a manual click
    ...
    <>
      ...
      <section className="relative overflow-hidden px-4 pb-16 pt-32 sm:px-6 sm:pb-24 sm:pt-40">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          >
            Graphic Design{" "}
            <span className="italic text-ion">&amp; Video Editing</span>
          </motion.h1>
          ...
          >
            {FORMATS_AND_PLATFORMS.map((platform) => (
              <span
                key={platform}
      ...
      {/* ---------- Whole-page content: what our design & editing service includes ---------- */}
        ...
        <div className="mx-auto max-w-6xl">
          ...
          >
            ...
            <h2 className="mt-4 font-display text-3xl font-semibold text-ink sm:text-4xl">
              Design and video, covered
            </h2>
            <h2 className="font-display text-3xl font-semibold text-ion sm:text-4xl">
              by one consistent visual system.
            </h2>
          </motion.div>
