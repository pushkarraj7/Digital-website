// src/pages/services/digital-marketing/WhatsAppMarketing.jsx
...
const SERVICE_CATEGORIES = [
  {
    ...
    icon: Send,
    tagline: "Reach thousands of customers without it feeling like spam.",
    description:
      "Segmented bulk sends with approved templates, so promotions and updates land in inboxes people actually open — not their spam folder.",
    features: [
  ...
  },
  {
    ...
    icon: Bot,
    tagline: "Answer the first question before a human even sees it.",
    description:
      "Rule-based and keyword-triggered bots that handle FAQs, order status and basic queries instantly, any time of day.",
    features: [
      "Keyword-triggered auto replies",
      "FAQ & order status flows",
      "Business hours & fallback routing",
  ...
  },
  {
    ...
    icon: Radio,
    tagline: "One message, sent the moment it matters.",
    description:
      "Announcement and offer broadcasts to your opted-in audience — new launches, sales, reminders — sent as one coordinated push.",
    features: [
      "Product launch & offer broadcasts",
      "Event & reminder campaigns",
      "List segmentation by interest",
  ...
  },
  {
    ...
    icon: Users2,
    tagline: "Turn a WhatsApp click-to-chat into a qualified contact.",
    description:
      "Click-to-WhatsApp ads and website widgets that capture interest the moment it happens, routed straight into your funnel.",
    features: [
  ...
  },
  {
    ...
    label: "Business API",
    icon: Webhook,
    tagline: "Connect WhatsApp to the tools you already run on.",
    description:
      "Official WhatsApp Business API setup and integration with your CRM, e-commerce store or support desk, done right the first time.",
    features: [
      "Business API setup & verification",
  ...
  },
  {
    ...
    icon: BarChart3,
    tagline: "See what's actually converting, not just what's sent.",
    description:
      "Delivery, read and response rates tracked per campaign, so you know which messages are working and which to drop.",
    features: [
      "Delivery & read-rate tracking",
      "Response & conversion reporting",
...
const DELIVERABLES = [
  {
    ...
    description:
      "Official, verified API access connected to your systems — done once, done properly.",
    color: "#7FB4FF",
  },
  {
    icon: MessageSquare,
    title: "Template & Campaign Design",
    description:
      "Approved message templates and campaign content built for engagement, not just compliance.",
    color: "#7F5FFF",
  },
  {
    icon: Bot,
    title: "Auto-Reply & Chatbot Flows",
    description:
      "Automated responses that handle the repetitive questions so your team can focus on the real ones.",
    color: "#FF8B6B",
  },
  {
    icon: Users2,
    ...
    description:
      "Every chat-started conversation captured as a lead and routed to the right person or list.",
    color: "#4E86FF",
  },
  {
    icon: ListChecks,
    ...
    description:
      "Messages sent to the right audience segment, not a single list blasted with everything.",
    color: "#22d3ee",
  },
  {
    icon: BarChart3,
    ...
    description:
      "Delivery, read and reply rates tracked per campaign, with monthly reviews on what to change.",
    color: "#f472b6",
  },
];
...
const PROCESS = [
  {
    ...
    title: "API Setup",
    description:
      "Verify your business and set up official WhatsApp Business API access.",
  },
  {
    index: "02",
    title: "Templates & Flows",
    description:
      "Build approved message templates and auto-reply flows for common queries.",
  },
  {
    index: "03",
    title: "Integrate",
    description:
      "Connect WhatsApp to your CRM, store or support desk so chats don't live in a silo.",
  },
  {
    index: "04",
    title: "Launch Campaigns",
    description:
      "Run segmented broadcasts and click-to-chat ads to start driving conversations.",
  },
  {
    index: "05",
    title: "Track & Refine",
    description:
      "Review delivery, read and response rates, and adjust messaging monthly.",
  },
];

export function WhatsAppMarketing() {
  const [activeId, setActiveId] = useState("bulk-messaging");
  ...
  return (
    <>
      ...
      {/* ---------- Whole-page content: what our WhatsApp marketing includes ---------- */}
            ...
            >
              <GlassPanel className="p-7 sm:p-8">
                ...
                <ul className="mt-5 flex flex-col gap-4">
                  {[
                    "Official Business API setup handled correctly the first time, no re-verification headaches.",
                    "Automation that reduces response time without losing the human touch.",
                    "Every campaign tracked by delivery, read and reply rate — not just messages sent.",
                  ].map((point) => (
                    <li
                      key={point}
      ...
      <section className="relative overflow-hidden bg-void px-4 py-20 sm:px-6 sm:py-28">
        ...
        <div className="relative mx-auto flex max-w-2xl flex-col items-center text-center">
          ...
          >
            Ready for a WhatsApp channel
            <br className="hidden sm:block" />{" "}
            <span className="italic text-ion">that works while you don't?</span>
          </motion.h2>
          <motion.div
            initial={{ opacity: 0, y: 16 }}
            whileInView={{ opacity: 1, y: 0 }}
